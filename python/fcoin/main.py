...
FC_ACCESS_KEY = "517f6e3079b0496d9f719acf68dff3d0"
FC_ACCESS_SIGNATURE = "e47ca12e3b18459585d85dec4f3bdeef"
FC_ACCESS_TIMESTAMP = ""
    ...
    def public_request(self, method, api_url, **payload):
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                raise Exception(False, {'error': 'E10000', 'data': r.status_code})
        except requests.exceptions.HTTPError as err:
            raise Exception(False, {'error': 'E10001', 'data': r.text})
        except Exception as err:
            raise Exception(False, {'error': 'E10002', 'data': err})
...
if __name__ == "__main__":
    """do your logic process"""
    fclient = Fcoin()
    fclient.auth(FC_ACCESS_KEY, FC_ACCESS_SIGNATURE)
    print(fclient.get_server_time())
    print(fclient.get_symbols())
    res, content = fclient.create_order(
        symbol='ftusdt',
        side='sell',
        type='limit',
        price=0.5,
